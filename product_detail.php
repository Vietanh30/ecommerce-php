            ...
            <div class="grid grid-cols-5 gap-4">
                ...
                <div class="col-span-2 bg-white rounded-xl px-4 pb-6 h-fit">
                    <div class='flex items-end gap-2'>
                        <div class='mt-4 text-[#dd2f2c] text-xl font-semibold selling_price'>Loading...</div> <!-- Placeholder for discount price -->
                        <div class='text-[#a4a4a4] line-through cost_price'>Loading...</div> <!-- Placeholder for cost price -->
                    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        $('.cost_price').text(`${number_format(parseInt(product.cost_price))}đ`);
                    } else {
